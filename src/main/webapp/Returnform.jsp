		...
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				<div
					...
					<h1 class="h2">Return Medicine</h1>
					...
					<div class="container">
						<div class="row">
                           ...
                           <div class="col-md-2">
										...
										<form action="/searchbyinvoicereturn">
										 <label class="form-label">Check invoice</label> 
										<input type="search"
											 id="invoice" name="invoice" ></form> 
											
									</div>
									
									 <div class="col-md-2">
						             
										<form action="/searchbynamereturn">
								...
								<form class="row g-3" action="/addritem">
								<div class="col-md-2">
										<label class="form-label">Purchase Date</label> <input
											type="date" class="form-control" id="sprice" name="" value="${ins.dos}">
									</div>
									<div class="col-md-2">
										<label class="form-label">Purchase Amount</label> <input
											type="text" class="form-control" id="sprice" name="" value="${ins.grandtotall}">
									</div>
									<div class="col-md-2">
										<label class="form-label">Invoice (L i: ${rom1})</label> <input type="text"
											class="form-control" id="invoice" name="invoice" value="0">
									</div>
					...
					<table class="table table-striped table-sm">
						<thead>
							...
							<tr>
					          ...
					          class="form-control" id="mvat" name="mvat" value="0"></th></th>
								<th scope="col">Less Amount(%)</th>
							...
							<tr>
								...
								<th scope="col"><input type="text"
											class="form-control" id="grandtotall" name="grandtotall" value="${gtot}"></th>
											
                               <th scope="col">
											<button type="submit" formaction="/showRamount" class="btn btn-primary" >Check
												</button>
										</th>
							</tr>
							...
							<tr>
                                ...
                                <th scope="col">
											<button type="submit" formaction="/return" class="btn btn-primary"  >Return
												</button>
