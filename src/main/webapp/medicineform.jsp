					...
					<div class="container">
						<div class="row">
							<div class="col">
								...
								<form class="row g-3" action="/newMedicine">
									...
									<div class="col-md-6">
										<label class="form-label">Generic</label> <input type="text"
											class="form-control" id="mgeneric" name="mgeneric">
									</div>
									

									<div class="col-md-6">
										<label class="form-label">Category</label> <input type="text"
											class="form-control" id="mcategory" name="mcategory">
									</div>
									<div class="col-md-6">
										<label class="form-label">Type</label> <input type="text"
											class="form-control" id="mtype" name="mtype">
									</div>
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<label class="form-label">Production Date</label> <input
											type="date" class="form-control" id="dop" name="dop">
									</div>
									<div class="col-md-6">
										<label class="form-label">Expired Date</label> <input
											type="date" class="form-control" id="doe" name="doe">
									</div>
									<div class="col-md-6">
										<label class="form-label">Medicine Price</label> <input
											type="text" class="form-control" id="mprice" name="mprice">
									</div>
									<div class="col-md-6">
										<label class="form-label">Supplier Price</label> <input
											type="text" class="form-control" id="sprice" name="sprice">
									</div>
									<div class="col-md-6">
										<label class="form-label">Vat(%)</label> <input type="text"
											class="form-control" id="mvat" name="mvat">
									</div>
									<div class="col-md-6">
										<label class="form-label">Stock</label> <input type="text"
											class="form-control" id="mstock" name="mstock">
									</div>
									<div class="col-md-6">
										<input
											type="hidden" class="form-control" id="mid" name="mid" value="0">
									</div>
									<div class="col-md-6">
										<input type="hidden"
											class="form-control" id="munit" name="munit" value="0">
									</div>
