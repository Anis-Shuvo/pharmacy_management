					...
					<div class="container">
						<div class="row">
							<div class="col">
								...
								<form class="row g-3" action="/updatecustomer">
									<div class="col-md-6">
										<label class="form-label">Customer ID:</label> <input
											type="text" class="form-control" id="cid" name="cid" value="${ml.cid}">
									</div>

									<div class="col-md-6">
										<label class="form-label">Customer Name:</label> <input
											type="text" class="form-control" id="cname" name="cname" value="${ml.cname}">
									</div>
									<div class="col-md-6">
										<label class="form-label">Mobile:</label> <input
											type="number" class="form-control" id="mobile" name="mobile" value="${ml.mobile}">
									</div>
									<div class="col-md-6">
										<label class="form-label">Email</label> <input type="text"
											class="form-control" id="email" name="email" value="${ml.email}">
									</div>

									<div class="col-md-6">
										<label class="form-label">Contact</label> <input 
										type="number" class="form-control" id="contact" name="contact" value="${ml.contact}">
									</div>
									<div class="col-md-6">
										<label class="form-label">Address</label>
										 <textarea 
										class="form-control" id="address" name="address" value="${ml.address}">${ml.address}</textarea>
									</div>
									<div class="col-md-6">
										<label class="form-label">City</label> <input type="text"
											class="form-control" id="city" name="city" value="${ml.city}">
									</div>
									
									<div class="col-12">
										<button type="submit" class="btn btn-primary" id="id"
											name="id">Update Customer</button>
									</div>
								</form>
