			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<div class="row">
					...
					<div class="card text-white bg-secondary m-3"
						...
						<div class="card-header"></div>
						<div class="card-body">
							<h5 class="card-title">Total Sell Today</h5>
							<h1 class="card-text m-2">${tdt}</h1>
						</div>
					</div>
					...
					<div class="card text-white bg-danger m-3"
						...
						<div class="card-body">
							...
							<h1 class="card-text m-2">${stock}</h1>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="card text-dark bg-info m-3" style="max-width: 18rem;">
						...
						<div class="card-body">
							...
							<h1 class="card-text m-2">${ctotal}</h1>
						</div>
					</div>
					<div class="card text-dark bg-light m-3" style="max-width: 18rem;">
						...
						<div class="card-body">
							...
							<h1 class="card-text m-2">${stotal}</h1>
						</div>
					</div>
					<div class="card text-white bg-dark m-3" style="max-width: 18rem;">
						<div class="card-header"></div>
						<div class="card-body">
							<h5 class="card-title">Supplier Due</h5>
							<h1 class="card-text m-2">${supdue}</h1>
						</div>
					</div>
				</div>
