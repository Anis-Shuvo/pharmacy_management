		...
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				<div
					...
					<h1 class="h2">Purchase Medicine</h1>
					...
					<div class="container">
						<div class="row">
							<div class="col">
								...
								<form class="row g-3" action="/addpurchase">
									<div class="col-md-2">
										<label class="form-label">Invoice (L i: ${rom3})</label> <input type="text"
											class="form-control" id="invoice" name="invoice" value="${rom2}">
									</div>
						

									<div class="col-md-2">
										<label class="form-label">Supllier Name:</label> <input
											type="text" class="form-control" id="supplier" name="supplier">
									</div>
									
									<div class="col-md-2">
										<label class="form-label">Medicine Name:</label> <input type="text"
											class="form-control" id="mname" name="mname" value="">
									</div>
									...
									<div class="col-md-2">
										<label class="form-label">Purchase date</label> <input type="date"
											class="form-control" id="dop" name="dop" Value="${cdate}">
									</div>
									<div class="col-md-2">
										<label class="form-label">Expired Date</label> <input type="date"
											class="form-control" id="expired" name="expired" value="">
									</div>
									<div class="col-md-2">
									...
									<div class="col-md-2">
										<label class="form-label">Supplier price</label> <input type="text"
											class="form-control" id="sprice" name="sprice" value="">
									</div>
									...
									<div class="col-md-2">
										<input
											type="hidden" class="form-control" id="pid" name="pid" value="0">
									</div>
					...
					<table class="table table-striped table-sm">
						<thead>
								...
								<tr>
									...
									<td>
										<form action="/deletepurchase">
											<button type="submit" class="btn btn-danger" value="${t.pid}"
												name="pid">
							...
							<tr>
                               ...
                               <th scope="col">
											<button type="submit" formaction="/showPamount" class="btn btn-primary" >Check
												</button>
										</th>
							</tr>
							...
							<tr>
                                ...
                                <th scope="col">
											<button type="submit" formaction="/purchase" class="btn btn-primary"  >Purchase
												</button>
